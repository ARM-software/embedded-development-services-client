...
func (a *BuildJobsApiService) FollowMessageLink(r ApiGetBuildMessagesRequest, link string) (*BuildMessageItem, *http.Response, GenericOpenAPIError) {
	...
	// These line are the only differences from the GetBuildMessages function,
...
func (a *VHTRunJobsApiService) FollowMessageLink(r ApiGetVhtRunJobMessagesRequest, link string) (NotificationFeed, *http.Response, GenericOpenAPIError) {
	...
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFiles)
	if err != nil {
		executionError.error = err.Error()
		return localVarReturnValue, nil, executionError
	}
