...
func (r *ApiListGenericWorkJobsRequest) FollowGenericWorkJobLink(link string) (*GenericWorkJobCollection, *http.Response, error) {
	return r.ApiService.FollowGenericWorkJobLink(r, link)
}

func (a *GenericWorkJobsAPIService) FollowGenericWorkJobLink(r *ApiListGenericWorkJobsRequest, link string) (*GenericWorkJobCollection, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GenericWorkJobsAPIService.ListGenericWorkJob")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	// NOTE:
	// These lines are the only differences from the `ListGenericWorkJobExecute` function,
