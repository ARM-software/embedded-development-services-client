...
func (r *ApiListResourceInstanceEntitlementsRequest) FollowResourceInstanceEntitlementsLink(link string) (*InstancePermissionCollection, *http.Response, error) {
	return r.ApiService.FollowResourceInstanceEntitlementsLink(r, link)
}

// Follows a collection link. This function is based on the `ListResourceInstanceEntitlementsExecute` function, with one key difference:
