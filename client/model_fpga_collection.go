...
// checks if the FPGACollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FPGACollection{}
...
type _FPGACollection FPGACollection
...
func (o *FPGACollection) UnmarshalJSON(data []byte) (err error) {
	...
	varFPGACollection := _FPGACollection{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFPGACollection)

	if err != nil {
		return err
	}

	*o = FPGACollection(varFPGACollection)

	return err
}

type NullableFPGACollection struct {
	value *FPGACollection
	isSet bool
}
...
func NewNullableFPGACollection(val *FPGACollection) *NullableFPGACollection {
	return &NullableFPGACollection{value: val, isSet: true}
}
