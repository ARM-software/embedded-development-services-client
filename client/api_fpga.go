...
func (r ApiSunsetFpgaRequest) Execute() (*FPGAJobItem, *http.Response, error) {
	return r.ApiService.SunsetFpgaExecute(r)
}
...
func (a *FPGAAPIService) SunsetFpgaExecute(r ApiSunsetFpgaRequest) (*FPGAJobItem, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FPGAAPIService.SunsetFpga")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/fpgas/{fpgaName}/sunset"
