...
type _ArtefactManagerCollection ArtefactManagerCollection
...
func NewArtefactManagerCollection(links NullableHalCollectionLinks, metadata NullablePagingMetadata, name string, title string) *ArtefactManagerCollection {
	this := ArtefactManagerCollection{}
	this.Links = links
...
func (o *ArtefactManagerCollection) GetEmbedded() EmbeddedArtefactManagerItems {
	if o == nil || IsNil(o.Embedded) {
		var ret EmbeddedArtefactManagerItems
		return ret
	}
	return *o.Embedded
}
...
func (o *ArtefactManagerCollection) UnmarshalJSON(bytes []byte) (err error) {
	...
	varArtefactManagerCollection := _ArtefactManagerCollection{}

	err = json.Unmarshal(bytes, &varArtefactManagerCollection)

	if err != nil {
		return err
	}

	*o = ArtefactManagerCollection(varArtefactManagerCollection)

	return err
}

type NullableArtefactManagerCollection struct {
	value *ArtefactManagerCollection
	isSet bool
}
...
func NewNullableArtefactManagerCollection(val *ArtefactManagerCollection) *NullableArtefactManagerCollection {
	return &NullableArtefactManagerCollection{value: val, isSet: true}
}
