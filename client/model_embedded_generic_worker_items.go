...
// checks if the EmbeddedGenericWorkerItems type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmbeddedGenericWorkerItems{}
...
func NewEmbeddedGenericWorkerItems() *EmbeddedGenericWorkerItems {
	this := EmbeddedGenericWorkerItems{}
	return &this
}
...
type NullableEmbeddedGenericWorkerItems struct {
	value *EmbeddedGenericWorkerItems
	isSet bool
}
...
func NewNullableEmbeddedGenericWorkerItems(val *EmbeddedGenericWorkerItems) *NullableEmbeddedGenericWorkerItems {
	return &NullableEmbeddedGenericWorkerItems{value: val, isSet: true}
}
