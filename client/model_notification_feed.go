...
// If the value is explicit nil, the zero value for []NotificationMessageObject will be returned
func (o *NotificationFeed) GetMessages() []NotificationMessageObject {
	if o == nil {
		var ret []NotificationMessageObject
		return ret
	}
...
func NewNullableNotificationFeed(val *NotificationFeed) *NullableNotificationFeed {
	return &NullableNotificationFeed{value: val, isSet: true}
}
