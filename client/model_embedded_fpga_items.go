...
// checks if the EmbeddedFPGAItems type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmbeddedFPGAItems{}
...
func NewNullableEmbeddedFPGAItems(val *EmbeddedFPGAItems) *NullableEmbeddedFPGAItems {
	return &NullableEmbeddedFPGAItems{value: val, isSet: true}
}
