...
type ApiGetVendorExternalRequest struct {
	ctx context.Context
	ApiService *VendorsApiService
	externalId string
	type_ string
...
// Versioning: Optional header to request a specific version of the API. While it is possible to specify a particular major, minor or patch version it is not recommended for production use cases. Only the major version number should be specified as minor and patch versions can be updated without warning.
func (r ApiGetVendorExternalRequest) AcceptVersion(acceptVersion string) ApiGetVendorExternalRequest {
	r.acceptVersion = &acceptVersion
	return r
}

func (r ApiGetVendorExternalRequest) Execute() (*VendorItem, *http.Response, error) {
	return r.ApiService.GetVendorExternalExecute(r)
}

/*
GetVendorExternal Get a Vendor Item By Type & ExternalId

Get a specific Vendor Item using an external identifier, and the source type of this identifier.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param externalId The external identifier from the original data source for this Vendor
 @param type_ The type of the following ExternalId, e.g. `bVendor`, `dVendor`
 @return ApiGetVendorExternalRequest
*/
func (a *VendorsApiService) GetVendorExternal(ctx context.Context, externalId string, type_ string) ApiGetVendorExternalRequest {
	return ApiGetVendorExternalRequest{
		ApiService: a,
		ctx: ctx,
...
// Execute executes the request
//  @return VendorItem
func (a *VendorsApiService) GetVendorExternalExecute(r ApiGetVendorExternalRequest) (*VendorItem, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "VendorsApiService.GetVendorExternal")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/vendors/{type}/{externalId}"
