...
// checks if the EmbeddedUserItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmbeddedUserItem{}
...
func NewNullableEmbeddedUserItem(val *EmbeddedUserItem) *NullableEmbeddedUserItem {
	return &NullableEmbeddedUserItem{value: val, isSet: true}
}
