...
// checks if the EmbeddedCmsisBuilderItems type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmbeddedCmsisBuilderItems{}
...
func NewEmbeddedCmsisBuilderItems() *EmbeddedCmsisBuilderItems {
	this := EmbeddedCmsisBuilderItems{}
	return &this
}
...
type NullableEmbeddedCmsisBuilderItems struct {
	value *EmbeddedCmsisBuilderItems
	isSet bool
}
...
func NewNullableEmbeddedCmsisBuilderItems(val *EmbeddedCmsisBuilderItems) *NullableEmbeddedCmsisBuilderItems {
	return &NullableEmbeddedCmsisBuilderItems{value: val, isSet: true}
}
