...
// checks if the FPGAJobCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FPGAJobCollection{}
...
type FPGAJobCollection struct {
	Embedded *EmbeddedFPGAJobItems `json:"_embedded,omitempty"`
...
type _FPGAJobCollection FPGAJobCollection
...
func (o *FPGAJobCollection) UnmarshalJSON(data []byte) (err error) {
	...
	varFPGAJobCollection := _FPGAJobCollection{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFPGAJobCollection)

	if err != nil {
		return err
	}

	*o = FPGAJobCollection(varFPGAJobCollection)

	return err
}

type NullableFPGAJobCollection struct {
	value *FPGAJobCollection
	isSet bool
}
...
func NewNullableFPGAJobCollection(val *FPGAJobCollection) *NullableFPGAJobCollection {
	return &NullableFPGAJobCollection{value: val, isSet: true}
}
