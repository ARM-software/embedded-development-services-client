...
// checks if the ListVendorsCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListVendorsCollection{}
...
type _ListVendorsCollection ListVendorsCollection
...
func (o *ListVendorsCollection) UnmarshalJSON(bytes []byte) (err error) {
	...
	varListVendorsCollection := _ListVendorsCollection{}

	err = json.Unmarshal(bytes, &varListVendorsCollection)

	if err != nil {
		return err
	}

	*o = ListVendorsCollection(varListVendorsCollection)

	return err
}

type NullableListVendorsCollection struct {
	value *ListVendorsCollection
	isSet bool
}
...
func NewNullableListVendorsCollection(val *ListVendorsCollection) *NullableListVendorsCollection {
	return &NullableListVendorsCollection{value: val, isSet: true}
}
