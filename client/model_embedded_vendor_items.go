...
// checks if the EmbeddedVendorItems type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmbeddedVendorItems{}
...
func NewNullableEmbeddedVendorItems(val *EmbeddedVendorItems) *NullableEmbeddedVendorItems {
	return &NullableEmbeddedVendorItems{value: val, isSet: true}
}
