...
func (r ApiCheckFPGAPayloadStatusRequest) Execute() (*FPGAPayloadItem, *http.Response, error) {
	return r.ApiService.CheckFPGAPayloadStatusExecute(r)
}

/*
CheckFPGAPayloadStatus Check and update the payload status.

Check and update the payload status against the upload job for this payload.
 ...
 @return ApiCheckFPGAPayloadStatusRequest
*/
...
func (a *FPGAPayloadsAPIService) CheckFPGAPayloadStatusExecute(r ApiCheckFPGAPayloadStatusRequest) (*FPGAPayloadItem, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FPGAPayloadsAPIService.CheckFPGAPayloadStatus")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/repositories/{repositoryName}/payloads/{fpgaPayloadName}/check"
...
func (r ApiGetFpgaPayloadUploadJobMessagesRequest) Execute() (*NotificationFeed, *http.Response, error) {
	return r.ApiService.GetFpgaPayloadUploadJobMessagesExecute(r)
}

/*
GetFpgaPayloadUploadJobMessages FPGA payload upload job Message Feed.

Retrieve and page through the messages for a given job.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uploadJobName Unique ID of the FPGA payload upload job.
 @return ApiGetFpgaPayloadUploadJobMessagesRequest
*/
...
func (a *FPGAPayloadsAPIService) GetFpgaPayloadUploadJobMessagesExecute(r ApiGetFpgaPayloadUploadJobMessagesRequest) (*NotificationFeed, *http.Response, error) {
	...
	localVarPath := localBasePath + "/upload-jobs/{uploadJobName}/messages"
