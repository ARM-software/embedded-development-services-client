...
// checks if the BuildJobCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BuildJobCollection{}
...
type _BuildJobCollection BuildJobCollection
...
func (o *BuildJobCollection) UnmarshalJSON(bytes []byte) (err error) {
	...
	varBuildJobCollection := _BuildJobCollection{}

	err = json.Unmarshal(bytes, &varBuildJobCollection)

	if err != nil {
		return err
	}

	*o = BuildJobCollection(varBuildJobCollection)

	return err
}

type NullableBuildJobCollection struct {
	value *BuildJobCollection
	isSet bool
}
...
func NewNullableBuildJobCollection(val *BuildJobCollection) *NullableBuildJobCollection {
	return &NullableBuildJobCollection{value: val, isSet: true}
}
