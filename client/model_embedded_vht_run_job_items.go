...
// checks if the EmbeddedVhtRunJobItems type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmbeddedVhtRunJobItems{}
...
func NewNullableEmbeddedVhtRunJobItems(val *EmbeddedVhtRunJobItems) *NullableEmbeddedVhtRunJobItems {
	return &NullableEmbeddedVhtRunJobItems{value: val, isSet: true}
}
