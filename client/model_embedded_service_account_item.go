...
// checks if the EmbeddedServiceAccountItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmbeddedServiceAccountItem{}
...
func NewEmbeddedServiceAccountItem() *EmbeddedServiceAccountItem {
	this := EmbeddedServiceAccountItem{}
	return &this
}
...
type NullableEmbeddedServiceAccountItem struct {
	value *EmbeddedServiceAccountItem
	isSet bool
}
...
func NewNullableEmbeddedServiceAccountItem(val *EmbeddedServiceAccountItem) *NullableEmbeddedServiceAccountItem {
	return &NullableEmbeddedServiceAccountItem{value: val, isSet: true}
}
