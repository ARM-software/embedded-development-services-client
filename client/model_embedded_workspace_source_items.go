...
// checks if the EmbeddedWorkspaceSourceItems type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmbeddedWorkspaceSourceItems{}
...
func NewEmbeddedWorkspaceSourceItems() *EmbeddedWorkspaceSourceItems {
	this := EmbeddedWorkspaceSourceItems{}
	return &this
}
...
type NullableEmbeddedWorkspaceSourceItems struct {
	value *EmbeddedWorkspaceSourceItems
	isSet bool
}
...
func NewNullableEmbeddedWorkspaceSourceItems(val *EmbeddedWorkspaceSourceItems) *NullableEmbeddedWorkspaceSourceItems {
	return &NullableEmbeddedWorkspaceSourceItems{value: val, isSet: true}
}
