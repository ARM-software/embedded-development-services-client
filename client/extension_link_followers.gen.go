...
// =================================================================================================================
// This extends ApiListAnalysersRequest and AnalyserAPIService definitions
// =================================================================================================================
func (r *ApiListAnalysersRequest) FollowAnalysersLink(link string) (*AnalyserCollection, *http.Response, error) {
	return r.ApiService.FollowAnalysersLink(r, link)
}

// Follows a collection link. This function is based on the `ListAnalysersExecute` function, with one key difference:
// instead of using a fixed endpoint path, `localVarPath` is defined as the base URL + the `link` provided in the arguments.
func (a *AnalyserAPIService) FollowAnalysersLink(r *ApiListAnalysersRequest, link string) (*AnalyserCollection, *http.Response, error) {
	var (
