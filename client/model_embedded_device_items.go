...
// checks if the EmbeddedDeviceItems type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmbeddedDeviceItems{}
...
func NewNullableEmbeddedDeviceItems(val *EmbeddedDeviceItems) *NullableEmbeddedDeviceItems {
	return &NullableEmbeddedDeviceItems{value: val, isSet: true}
}
