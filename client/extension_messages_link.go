...
func (a *VHTRunJobsAPIService) FollowMessageLink(r *ApiGetVhtRunJobMessagesRequest, link string) (*NotificationFeed, *http.Response, error) {
	...
	// NOTE:
	// These lines are the only differences from the `GetVhtRunJobMessagesExecute` function,
	// we specify the destination of the call by appending the link that is to be followed
	localVarPath := localBasePath + link
	// **************************************************************************************************************
...
func (r *ApiGetGenericWorkJobMessagesRequest) FollowMessageLink(link string) (*NotificationFeed, *http.Response, error) {
	return r.ApiService.FollowMessageLink(r, link)
}

func (a *GenericWorkJobsAPIService) FollowMessageLink(r *ApiGetGenericWorkJobMessagesRequest, link string) (*NotificationFeed, *http.Response, error) {
	...
	// NOTE:
	// These lines are the only differences from the `GetGenericWorkJobMessagesExecute` function,
	// we specify the destination of the call by appending the link that is to be followed
	localVarPath := localBasePath + link
	// **************************************************************************************************************
