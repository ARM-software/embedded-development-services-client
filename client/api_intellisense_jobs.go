...
func (r ApiGetIntellisenseJobArtefactManagerRequest) Execute() (*ArtefactManagerItem, *http.Response, error) {
	return r.ApiService.GetIntellisenseJobArtefactManagerExecute(r)
}
...
An output represents a product/artefact of the intellisense process.
...
func (a *IntellisenseJobsAPIService) GetIntellisenseJobArtefactManagerExecute(r ApiGetIntellisenseJobArtefactManagerRequest) (*ArtefactManagerItem, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IntellisenseJobsAPIService.GetIntellisenseJobArtefactManager")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/intellisense-jobs/{jobName}/outputs/{artefactName}"
	localVarPath = strings.Replace(localVarPath, "{"+"artefactName"+"}", parameterValueToString(r.artefactName, "artefactName"), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"jobName"+"}", parameterValueToString(r.jobName, "jobName"), -1)
...
func (r ApiGetIntellisenseOutputArtefactRequest) Execute() (*os.File, *http.Response, error) {
	return r.ApiService.GetIntellisenseOutputArtefactExecute(r)
}
...
func (a *IntellisenseJobsAPIService) GetIntellisenseOutputArtefactExecute(r ApiGetIntellisenseOutputArtefactRequest) (*os.File, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IntellisenseJobsAPIService.GetIntellisenseOutputArtefact")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/intellisense-jobs/{jobName}/outputs/{artefactName}/artefact"
	localVarPath = strings.Replace(localVarPath, "{"+"artefactName"+"}", parameterValueToString(r.artefactName, "artefactName"), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"jobName"+"}", parameterValueToString(r.jobName, "jobName"), -1)
...
func (r ApiListIntellisenseOutputManagersRequest) Execute() (*ArtefactManagerCollection, *http.Response, error) {
	return r.ApiService.ListIntellisenseOutputManagersExecute(r)
}
...
func (a *IntellisenseJobsAPIService) ListIntellisenseOutputManagersExecute(r ApiListIntellisenseOutputManagersRequest) (*ArtefactManagerCollection, *http.Response, error) {
	...
	localVarPath := localBasePath + "/intellisense-jobs/{jobName}/outputs/"
	localVarPath = strings.Replace(localVarPath, "{"+"jobName"+"}", parameterValueToString(r.jobName, "jobName"), -1)
