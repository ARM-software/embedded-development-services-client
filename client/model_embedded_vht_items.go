...
// checks if the EmbeddedVhtItems type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmbeddedVhtItems{}
...
func NewNullableEmbeddedVhtItems(val *EmbeddedVhtItems) *NullableEmbeddedVhtItems {
	return &NullableEmbeddedVhtItems{value: val, isSet: true}
}
