...
// checks if the GenericWorkJobCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GenericWorkJobCollection{}
...
type _GenericWorkJobCollection GenericWorkJobCollection
...
func (o *GenericWorkJobCollection) GetEmbedded() EmbeddedGenericWorkJobItems {
	if o == nil || IsNil(o.Embedded) {
		var ret EmbeddedGenericWorkJobItems
		return ret
	}
	return *o.Embedded
}
...
func (o *GenericWorkJobCollection) UnmarshalJSON(data []byte) (err error) {
	...
	varGenericWorkJobCollection := _GenericWorkJobCollection{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGenericWorkJobCollection)

	if err != nil {
		return err
	}

	*o = GenericWorkJobCollection(varGenericWorkJobCollection)

	return err
}

type NullableGenericWorkJobCollection struct {
	value *GenericWorkJobCollection
	isSet bool
}
...
func NewNullableGenericWorkJobCollection(val *GenericWorkJobCollection) *NullableGenericWorkJobCollection {
	return &NullableGenericWorkJobCollection{value: val, isSet: true}
}
