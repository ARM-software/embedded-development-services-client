...
// checks if the EmbeddedWorkspaceItems type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmbeddedWorkspaceItems{}
...
func NewNullableEmbeddedWorkspaceItems(val *EmbeddedWorkspaceItems) *NullableEmbeddedWorkspaceItems {
	return &NullableEmbeddedWorkspaceItems{value: val, isSet: true}
}
