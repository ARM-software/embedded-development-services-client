...
// checks if the CmsisIntellisenseItemDeprecationInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CmsisIntellisenseItemDeprecationInfo{}
