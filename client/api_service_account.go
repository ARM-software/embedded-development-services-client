...
func (r ApiGetSATRequest) Execute() (*ServiceAccessTokenItem, *http.Response, error) {
	return r.ApiService.GetSATExecute(r)
}

/*
GetSAT Get a service access token.

Get a specific service access token that belongs to the service account.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param accessTokenName Unique ID of the access token.
 @param serviceAccountName Unique ID of the service account.
 @return ApiGetSATRequest
*/
...
func (a *ServiceAccountAPIService) GetSATExecute(r ApiGetSATRequest) (*ServiceAccessTokenItem, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServiceAccountAPIService.GetSAT")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
