...
// checks if the GenericWorkerCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GenericWorkerCollection{}
...
type _GenericWorkerCollection GenericWorkerCollection
...
func (o *GenericWorkerCollection) GetEmbedded() EmbeddedGenericWorkerItems {
	if o == nil || IsNil(o.Embedded) {
		var ret EmbeddedGenericWorkerItems
		return ret
	}
	return *o.Embedded
}
...
func (o *GenericWorkerCollection) UnmarshalJSON(data []byte) (err error) {
	...
	varGenericWorkerCollection := _GenericWorkerCollection{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGenericWorkerCollection)

	if err != nil {
		return err
	}

	*o = GenericWorkerCollection(varGenericWorkerCollection)

	return err
}

type NullableGenericWorkerCollection struct {
	value *GenericWorkerCollection
	isSet bool
}
...
func NewNullableGenericWorkerCollection(val *GenericWorkerCollection) *NullableGenericWorkerCollection {
	return &NullableGenericWorkerCollection{value: val, isSet: true}
}
