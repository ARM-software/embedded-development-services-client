...
// checks if the EmbeddedFPGAPayloadItems type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmbeddedFPGAPayloadItems{}
...
type NullableEmbeddedFPGAPayloadItems struct {
	value *EmbeddedFPGAPayloadItems
	isSet bool
}
...
func NewNullableEmbeddedFPGAPayloadItems(val *EmbeddedFPGAPayloadItems) *NullableEmbeddedFPGAPayloadItems {
	return &NullableEmbeddedFPGAPayloadItems{value: val, isSet: true}
}
