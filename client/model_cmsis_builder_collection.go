...
type _CmsisBuilderCollection CmsisBuilderCollection
...
func (o *CmsisBuilderCollection) UnmarshalJSON(bytes []byte) (err error) {
	...
	varCmsisBuilderCollection := _CmsisBuilderCollection{}

	err = json.Unmarshal(bytes, &varCmsisBuilderCollection)

	if err != nil {
		return err
	}

	*o = CmsisBuilderCollection(varCmsisBuilderCollection)
