...
// checks if the EmbeddedPATItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmbeddedPATItem{}
...
func NewNullableEmbeddedPATItem(val *EmbeddedPATItem) *NullableEmbeddedPATItem {
	return &NullableEmbeddedPATItem{value: val, isSet: true}
}
