...
// checks if the FPGAAdminCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FPGAAdminCollection{}
...
type _FPGAAdminCollection FPGAAdminCollection
...
func (o *FPGAAdminCollection) UnmarshalJSON(data []byte) (err error) {
	...
	varFPGAAdminCollection := _FPGAAdminCollection{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFPGAAdminCollection)

	if err != nil {
		return err
	}

	*o = FPGAAdminCollection(varFPGAAdminCollection)

	return err
}

type NullableFPGAAdminCollection struct {
	value *FPGAAdminCollection
	isSet bool
}
...
func NewNullableFPGAAdminCollection(val *FPGAAdminCollection) *NullableFPGAAdminCollection {
	return &NullableFPGAAdminCollection{value: val, isSet: true}
}
