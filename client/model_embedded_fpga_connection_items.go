...
// checks if the EmbeddedFPGAConnectionItems type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmbeddedFPGAConnectionItems{}
...
func NewEmbeddedFPGAConnectionItems() *EmbeddedFPGAConnectionItems {
	this := EmbeddedFPGAConnectionItems{}
	return &this
}
...
type NullableEmbeddedFPGAConnectionItems struct {
	value *EmbeddedFPGAConnectionItems
	isSet bool
}
...
func NewNullableEmbeddedFPGAConnectionItems(val *EmbeddedFPGAConnectionItems) *NullableEmbeddedFPGAConnectionItems {
	return &NullableEmbeddedFPGAConnectionItems{value: val, isSet: true}
}
