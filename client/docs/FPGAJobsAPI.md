...
[**DownloadSpecificFpgaJobArtefact**](FPGAJobsAPI.md#DownloadSpecificFpgaJobArtefact) | **Get** /fpgas/{fpgaName}/jobs/{jobName}/artefacts/{artefactName}/artefact | Download the artefact for the corresponding FPGA job.
...
[**GetSpecificFpgaJob**](FPGAJobsAPI.md#GetSpecificFpgaJob) | **Get** /fpgas/{fpgaName}/jobs/{jobName} | Return a job handled by the FPGA.
[**GetSpecificFpgaJobArtefactManager**](FPGAJobsAPI.md#GetSpecificFpgaJobArtefactManager) | **Get** /fpgas/{fpgaName}/jobs/{jobName}/artefacts/{artefactName} | Get the FPGA job&#39;s artefact manager for the artefact named &#x60;artefactName&#x60;.
[**GetSpecificFpgaJobMessages**](FPGAJobsAPI.md#GetSpecificFpgaJobMessages) | **Get** /fpgas/{fpgaName}/jobs/{jobName}/messages | FPGA job Message Feed.
...
[**ListSpecificFpgaJobArtefactManagers**](FPGAJobsAPI.md#ListSpecificFpgaJobArtefactManagers) | **Get** /fpgas/{fpgaName}/jobs/{jobName}/artefacts/ | Get the list of artefact managers for the given FPGA job.
...
## DownloadSpecificFpgaJobArtefact

> *os.File DownloadSpecificFpgaJobArtefact(ctx, artefactName, jobName, fpgaName).AcceptVersion(acceptVersion).IfNoneMatch(ifNoneMatch).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.FPGAJobsAPI.DownloadSpecificFpgaJobArtefact(context.Background(), artefactName, jobName, fpgaName).AcceptVersion(acceptVersion).IfNoneMatch(ifNoneMatch).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `FPGAJobsAPI.DownloadSpecificFpgaJobArtefact``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `DownloadSpecificFpgaJobArtefact`: *os.File
	fmt.Fprintf(os.Stdout, "Response from `FPGAJobsAPI.DownloadSpecificFpgaJobArtefact`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDownloadSpecificFpgaJobArtefactRequest struct via the builder pattern
...
> FPGAJobItem GetSpecificFpgaJob(ctx, jobName, fpgaName).AcceptVersion(acceptVersion).IfNoneMatch(ifNoneMatch).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.FPGAJobsAPI.GetSpecificFpgaJob(context.Background(), jobName, fpgaName).AcceptVersion(acceptVersion).IfNoneMatch(ifNoneMatch).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `FPGAJobsAPI.GetSpecificFpgaJob``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetSpecificFpgaJob`: FPGAJobItem
	fmt.Fprintf(os.Stdout, "Response from `FPGAJobsAPI.GetSpecificFpgaJob`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetSpecificFpgaJobRequest struct via the builder pattern
...
## GetSpecificFpgaJobArtefactManager

> ArtefactManagerItem GetSpecificFpgaJobArtefactManager(ctx, artefactName, jobName, fpgaName).AcceptVersion(acceptVersion).IfNoneMatch(ifNoneMatch).Execute()

Get the FPGA job's artefact manager for the artefact named `artefactName`.
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.FPGAJobsAPI.GetSpecificFpgaJobArtefactManager(context.Background(), artefactName, jobName, fpgaName).AcceptVersion(acceptVersion).IfNoneMatch(ifNoneMatch).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `FPGAJobsAPI.GetSpecificFpgaJobArtefactManager``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetSpecificFpgaJobArtefactManager`: ArtefactManagerItem
	fmt.Fprintf(os.Stdout, "Response from `FPGAJobsAPI.GetSpecificFpgaJobArtefactManager`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetSpecificFpgaJobArtefactManagerRequest struct via the builder pattern
...
## GetSpecificFpgaJobMessages

> NotificationFeed GetSpecificFpgaJobMessages(ctx, jobName, fpgaName).AcceptVersion(acceptVersion).IfNoneMatch(ifNoneMatch).Limit(limit).Offset(offset).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.FPGAJobsAPI.GetSpecificFpgaJobMessages(context.Background(), jobName, fpgaName).AcceptVersion(acceptVersion).IfNoneMatch(ifNoneMatch).Limit(limit).Offset(offset).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `FPGAJobsAPI.GetSpecificFpgaJobMessages``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetSpecificFpgaJobMessages`: NotificationFeed
	fmt.Fprintf(os.Stdout, "Response from `FPGAJobsAPI.GetSpecificFpgaJobMessages`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetSpecificFpgaJobMessagesRequest struct via the builder pattern
...
## ListSpecificFpgaJobArtefactManagers

> ArtefactManagerCollection ListSpecificFpgaJobArtefactManagers(ctx, jobName, fpgaName).AcceptVersion(acceptVersion).Embed(embed).IfNoneMatch(ifNoneMatch).Limit(limit).Offset(offset).Execute()

Get the list of artefact managers for the given FPGA job.
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.FPGAJobsAPI.ListSpecificFpgaJobArtefactManagers(context.Background(), jobName, fpgaName).AcceptVersion(acceptVersion).Embed(embed).IfNoneMatch(ifNoneMatch).Limit(limit).Offset(offset).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `FPGAJobsAPI.ListSpecificFpgaJobArtefactManagers``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `ListSpecificFpgaJobArtefactManagers`: ArtefactManagerCollection
	fmt.Fprintf(os.Stdout, "Response from `FPGAJobsAPI.ListSpecificFpgaJobArtefactManagers`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiListSpecificFpgaJobArtefactManagersRequest struct via the builder pattern
...
func main() {
	fpgaName := "fpgaName_example" // string | Unique ID of an FPGA.
	fPGAJobItem := *openapiclient.NewFPGAJobItem("TODO", "TODO", true, true, false, true, "332129b3-f14d-49d2-b9be-acd2abd80c6b", false, true, "INITIALISING", NullableInt32(50), NullableInt32(70), false, true, false, *openapiclient.NewFPGATargetID("HardwareImage_example", "SoftwareImage_example"), *openapiclient.NewFPGAWorkload("payload0001", "./helloworld/sayhello")) // FPGAJobItem | A FPGA job to start.
	acceptVersion := "1.0.0" // string | Versioning: Optional header to request a specific version of the API. While it is possible to specify a particular major, minor or patch version it is not recommended for production use cases. Only the major version number should be specified as minor and patch versions can be updated without warning. (optional)
