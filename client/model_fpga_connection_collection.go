...
// checks if the FPGAConnectionCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FPGAConnectionCollection{}
...
type _FPGAConnectionCollection FPGAConnectionCollection
...
func (o *FPGAConnectionCollection) GetEmbedded() EmbeddedFPGAConnectionItems {
	if o == nil || IsNil(o.Embedded) {
		var ret EmbeddedFPGAConnectionItems
		return ret
	}
	return *o.Embedded
}
...
func (o *FPGAConnectionCollection) UnmarshalJSON(data []byte) (err error) {
	...
	varFPGAConnectionCollection := _FPGAConnectionCollection{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFPGAConnectionCollection)

	if err != nil {
		return err
	}

	*o = FPGAConnectionCollection(varFPGAConnectionCollection)

	return err
}

type NullableFPGAConnectionCollection struct {
	value *FPGAConnectionCollection
	isSet bool
}
...
func NewNullableFPGAConnectionCollection(val *FPGAConnectionCollection) *NullableFPGAConnectionCollection {
	return &NullableFPGAConnectionCollection{value: val, isSet: true}
}
