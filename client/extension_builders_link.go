...
func (r *ApiListCmsisBuildersRequest) FollowBuildersLink(link string) (*CmsisBuilderCollection, *http.Response, error) {
	return r.ApiService.FollowBuildersLink(r, link)
}

func (a *CMSISBuildersApiService) FollowBuildersLink(r *ApiListCmsisBuildersRequest, link string) (*CmsisBuilderCollection, *http.Response, error) {
	var (
	...
	// NOTE:
	// These lines are the only differences from the `ListCmsisBuildersExecute` function,
