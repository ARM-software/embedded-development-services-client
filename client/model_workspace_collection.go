...
// checks if the WorkspaceCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkspaceCollection{}
...
type _WorkspaceCollection WorkspaceCollection
...
func (o *WorkspaceCollection) GetEmbedded() EmbeddedWorkspaceItems {
	if o == nil || IsNil(o.Embedded) {
		var ret EmbeddedWorkspaceItems
		return ret
	}
	return *o.Embedded
}
...
func (o *WorkspaceCollection) UnmarshalJSON(bytes []byte) (err error) {
	...
	varWorkspaceCollection := _WorkspaceCollection{}

	err = json.Unmarshal(bytes, &varWorkspaceCollection)

	if err != nil {
		return err
	}

	*o = WorkspaceCollection(varWorkspaceCollection)
...
func NewNullableWorkspaceCollection(val *WorkspaceCollection) *NullableWorkspaceCollection {
	return &NullableWorkspaceCollection{value: val, isSet: true}
}
