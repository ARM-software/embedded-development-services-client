...
func (r *ApiListWorkspacesRequest) FollowWorkspaceLink(link string) (*WorkspaceCollection, *http.Response, error) {
	return r.ApiService.FollowWorkspaceLink(r, link)
}

func (a *WorkspaceApiService) FollowWorkspaceLink(r *ApiListWorkspacesRequest, link string) (*WorkspaceCollection, *http.Response, error) {
	var (
	...
	// NOTE:
	// These lines are the only differences from the `ListWorkspacesExecute` function,
