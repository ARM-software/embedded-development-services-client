...
type _CmsisIntellisenseItemLinks CmsisIntellisenseItemLinks
...
func NewCmsisIntellisenseItemLinks(self HalLinkData) *CmsisIntellisenseItemLinks {
	this := CmsisIntellisenseItemLinks{}
	this.Self = self
	return &this
}
...
func (o *CmsisIntellisenseItemLinks) UnmarshalJSON(bytes []byte) (err error) {
	...
	varCmsisIntellisenseItemLinks := _CmsisIntellisenseItemLinks{}

	err = json.Unmarshal(bytes, &varCmsisIntellisenseItemLinks)

	if err != nil {
		return err
	}

	*o = CmsisIntellisenseItemLinks(varCmsisIntellisenseItemLinks)

	return err
}

type NullableCmsisIntellisenseItemLinks struct {
	value *CmsisIntellisenseItemLinks
	isSet bool
}
...
func NewNullableCmsisIntellisenseItemLinks(val *CmsisIntellisenseItemLinks) *NullableCmsisIntellisenseItemLinks {
	return &NullableCmsisIntellisenseItemLinks{value: val, isSet: true}
}
