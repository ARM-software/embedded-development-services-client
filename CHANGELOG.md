...
- Updated client due to schema changes (#20260120013504)
...
- Updated client due to schema changes (#20260113091829)
...
- Updated client due to schema changes (#20260101013602)
...
- Dependency upgrade: utils-1.145.1 (#20251231174814)
...
- Dependency upgrade: checkout-6 (#20251121090613)
- Dependency upgrade: codeql-action-4.31.5 (#20251125090748)
...
- Updated client due to schema changes (#20251219123721)
...
- Updated client due to schema changes (#20251217094829)
...
- Updated client due to schema changes (#20251216145904)
...
- Updated client due to schema changes (#20251205160955)
...
- Updated client due to schema changes (#20251128111914)
...
- Updated client due to schema changes (#20251128094947)
...
- Updated client due to schema changes (#20251126165759)
...
- Updated client due to schema changes (#20251124185300)
...
- Updated client due to schema changes (#20251124144941)
...
- Updated client due to schema changes (#20251118215723, #20251119151358, #20251119164126, #20251120090717)


Bugfixes
--------

- Dependency upgrade: golang-1.25.4 (#20251106090723)
- :bug: Fix link followers generation to avoid duplicate query params (#20251118205703)
...
- Updated client due to schema changes (#20251120013409)
...
- Updated client due to schema changes (#20251119160744)
...
- Updated client due to schema changes (#20251119143814)
...
- Updated client due to schema changes (#20251119112849)
...
- Updated client due to schema changes (#20251118153320)
...
- Updated client due to schema changes (#20251114110425)
...
- Updated client due to schema changes (#20251112162258)
...
- Updated client due to schema changes (#20251112115120)
...
- Updated client due to schema changes (#20251106131412)
...
- Updated client due to schema changes (#20251030013353)
...
- Updated client due to schema changes (#20251021130144)
...
- Updated client due to schema changes (#20251020222021)
...
- Updated client due to schema changes (#20251017185438)
...
- Dependency upgrade: codeql-action-3.30.4 (#20250926080557)
...
- Updated client due to schema changes (#20250715160917)
...
- Dependency upgrade: golang-1.24.4 (#20250623095149)
...
- Dependency upgrade: golang-1.24.3 (#20250507085713)
...
- Updated client due to schema changes (#20241127013253)
...
- Update client extension links (#20240110114027)
...
- Dependency upgrade: golang-1.19.4 (#20221209115022)
...
- Updated client due to schema changes (#202206291521, #202206301759, #202207031639, #202207081658, #202207110937, #202207111605, #202207120738)
